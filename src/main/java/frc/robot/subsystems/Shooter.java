...
/** This is the shooter control class */
public class Shooter extends SubsystemBase {
    ...
    public Shooter() {
        leftMotor = new TalonFX(ConstantsPorts.kShooterLeft, ConstantsPorts.kRoboRioCANBus);
        middleMotor = new TalonFX(ConstantsPorts.kShooterMiddle, ConstantsPorts.kRoboRioCANBus);
        rightMotor = new TalonFX(ConstantsPorts.kShooterRight, ConstantsPorts.kRoboRioCANBus);
    ...
    private void configureMotor(TalonFX motor, InvertedValue invertDirection) {
        final TalonFXConfiguration config = new TalonFXConfiguration()
                .withMotorOutput(
                        new MotorOutputConfigs().withInverted(invertDirection).withNeutralMode(NeutralModeValue.Coast))
    ...
    private void initSendable(SendableBuilder builder, TalonFX motor, String name) {
        builder.addDoubleProperty(
                name + " RPM", () -> motor.getVelocity().getValue().in(RPM), null);
        builder.addDoubleProperty(
                name + " Stator Current",
