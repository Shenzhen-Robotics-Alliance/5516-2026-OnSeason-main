...
public class AprilTagVision extends SubsystemBase {
    ...
    /**
     * public final Trigger cameraDisconnected = new Trigger(() -> { for (AprilTagVisionIO.CameraInputs input :
     * AprilTagVision.this.inputs) if (!input.cameraConnected) return true; return false; });
     */
}
